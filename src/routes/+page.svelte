<script lang="ts">
    ...
    const right_links = [["Archive", "./tokyo2"], ["#function_draw", "https://twitter.com/hashtag/function_draw?src=hashtag_click"], ["Youtube", "https://www.youtube.com/@function_draw"]];
...
<main id="page_main">
  ...
  <!-- footer-->
  <footer>
    <h5 style="font-weight: lighter">Copyright © draw(); All Rights Reserved.</h5>
  </footer>
</main>