<script lang="ts">
  // @ts-nocheck
  import AnimSlideElem from '$lib/tokyo4/tokyo4-anim-slide.svelte'
  import './page.css'
  import '../default.css'
...
<svelte:head>
  ...
  <meta property="og:title" content="draw(tokyo); #4" />
  <meta
...
<main id="page_tokyo4">
  ...
  <div id="performer">
    ...
    <p class="white_box">Main Floor</p>
    <ul>
      <div class="content">
      ...
      <div class="content">
        ...
        <p class="text">
          M4tt　Yebisu303　RIKUPI-X b2b ymg
        </p>
      </div>
      <div class="content">
